...
function populateForm() {
    ...
    if (storedData) {
        ...
        //Remove the data as soon it loads for the first time... (DIFFERENT FROM POST.JS)
        localStorage.removeItem('formData');
    }
}
...
function copyToClipboard(e) {
    ...
    // Retrieve the post ID from the HTML
    var postId = document.getElementById("post_id").value;

    fetch(`get-temporary-image-url-edit/${imageId}/`)
